...
public class ExpertGame extends Game {
    ...
    /**
     * Boolean attribute set to TRUE if the Postman character card is being played, FALSE otherwise
     */
    ...
    /**
     * Setter for the isPostmanActive attribute in this class
     * @param b boolean value to give to the isPostmanActive attribute
     */
    ...
    /**
     * Handles a request to buy and play a character card
     * @param event The event generated by the player interacting with the view
     * @throws NotYourTurnException It is not this player's turn
     * @throws InvalidPlayerInputException The player input given to play the character card is not valid
     * @throws InsufficientCoinsException The player does not have enough coins to buy the character card
     * @throws InvalidMoveException The request is coming in the wrong phase of the game
