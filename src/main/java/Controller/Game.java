...
public class Game implements Observer {
    ...
    /**
     * Used in expert game. Tells if the Postman character card is being played
     */
    ...
    /**
     * Sends the entire model to its observers
     */
     ...
     * @throws AssistantMissingException The assistant is not in the hand
     * @throws IllegalAssistantException The assistant cannot be played because another player already played it
    ...
    /**
     * Handles a request to move a student to the dining room
     * @param event The event generated by the player interacting with the view
    ...
    /**
     * Handles a request to move a student to an island
     * @param event The event generated by the player interacting with the view
     * @throws InvalidMoveException The request is coming from the right player but in the wrong game phase
     *                              or
     *                              Maximum amount of students have already been moved, can't move any more students
     * @throws NotYourTurnException It is not this player's turn
     * @throws NoSuchIslandException There is no island with the requested index
     * @throws NoSuchStudentsException The selected student is not in the entrance and can't be moved to an island
     */
    ...
    /**
     * Handles a request to move mother nature
     * @param event The event generated by the player interacting with the view
     * @throws InvalidMoveException The request is coming from the right player but in the wrong game phase
     * @throws NotYourTurnException The request is coming from the wrong player
     * @throws EmptyElementException if the player doesn't have enough towers
     * @throws FullElementException if the opposing player can't have any more towers (should never be called)
     */
    ...
    /**
     * Handles a player's request to pick the students from a cloud
     * @param event The event generated by the player interacting with the view
     * @throws NotYourTurnException The request is coming from the wrong player
     * @throws InvalidMoveException The request is coming from the right player but in the wrong game phase
     * @throws NoSuchCloudException The cloud index does not exist
     * @throws EmptyCloudException the accessed cloud is empty
    ...
    /**
     * Handles a request to pick a wizard
     * @param event The event generated by the player interacting with the view
     * @throws NotYourTurnException Not this player's turn
     * @throws InvalidMoveException This is not the phase of the game when wizards are chosen
     *                              or
     *                              This player has already chosen a wizard
     * @throws WizardAlreadyChosenException The selected wizard has already been chosen by another player
     * @throws IllegalWizardException The wizardID given does not correspond to any wizard
     */
    ...
    /**
     * Checks if the game has ended because someone played all their towers
     * @return The teamID of the winning team,
    ...
    /**
     * Checks if the game has ended because there are only 3 islands left
     * @return The teamID of the winning team,
     *         otherwise returns -1 if there are no winners.
     */
    ...
    /**
     * Checks if this is the last round of the game because the sack is empty
     */
    ...
    /**
     * Checks if this is the last round because all players ran out of assistant cards
     */
     ...
     * Checks who the winning team is.
     * @return the teamID of the winning team,
     *         otherwise returns -2 if it's a draw.
     *
     */
    ...
    /**
     * Initializes a new round when the previous one has completed the Action Phase.
     */
    ...
    /**
     * Reads an event from a json file and calls the appropriate handleEvent method
     * to handle the event.
     * @param json a json file containing an event
     * @throws Exception Something went wrong
     */
